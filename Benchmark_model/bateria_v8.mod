...
option show_stats 2;
option gurobi_options 'outlev=0 mipgap=0.01 timelim=1000 multiobj=1 pre:dualreductions=0 feastol=1e-2' ;
option presolve 20;
...
var buy_prev{i in 0 .. m, t in 0 .. n-1} <= Upper_buy, >= 0; #predosle nakupovana kapacita
var sell_prev{i in 0 .. m, t in 0 .. n-1} <= Upper_sell, >= 0; #predosle predavana kapacita
